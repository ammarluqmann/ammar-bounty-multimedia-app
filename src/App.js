...
const filteredFilesActive = filteredFiles.filter(file => {
  if (activeFilter === "all") {
    return true;
  }
    ...
    <div style={styles.container}>
     ...
     <div style={styles.controlTools}>
          ...
          <div style={styles.filterContainer}>
            ...
            <button
              style={activeFilter === 'video' ? styles.activeFilterButton : styles.filterButton}
              onClick={() => handleFilterChange('video')}
            >
              Video
            </button>
            <button
              style={activeFilter === 'audio' ? styles.activeFilterButton : styles.filterButton}
              onClick={() => handleFilterChange('audio')}
            >
              Audio
            </button>
            <button
              style={activeFilter === 'document' ? styles.activeFilterButton : styles.filterButton}
              onClick={() => handleFilterChange('document')}
            >
              Document
            </button>
            <button
              style={activeFilter === 'image' ? styles.activeFilterButton : styles.filterButton}
